...
```*/
    ...
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    /**Event with signature `AccountProtocolFees(uint64,address,address,uint256)` and selector `0x0d6d7b8dfb5a2d4658c5aec0a2360b696002baf9e3701b7f002383b6aafc17fe`.
```solidity
event AccountProtocolFees(uint64 indexed rewardsType, address indexed network, address indexed token, uint256 fees);
```*/
    #[allow(
    ...
    #[derive(Clone)]
    pub struct AccountProtocolFees {
        #[allow(missing_docs)]
        pub rewardsType: u64,
        #[allow(missing_docs)]
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        #[automatically_derived]
        impl alloy_sol_types::SolEvent for AccountProtocolFees {
            ...
            const SIGNATURE: &'static str = "AccountProtocolFees(uint64,address,address,uint256)";
            const SIGNATURE_HASH: alloy_sol_types::private::B256 = alloy_sol_types::private::B256::new([
                13u8, 109u8, 123u8, 141u8, 251u8, 90u8, 45u8, 70u8, 88u8, 197u8, 174u8,
                192u8, 162u8, 54u8, 11u8, 105u8, 96u8, 2u8, 186u8, 249u8, 227u8, 112u8,
                27u8, 127u8, 0u8, 35u8, 131u8, 182u8, 170u8, 252u8, 23u8, 254u8,
            ]);
        ...
        #[automatically_derived]
        impl alloy_sol_types::private::IntoLogData for AccountProtocolFees {
        ...
        #[automatically_derived]
        impl From<&AccountProtocolFees> for alloy_sol_types::private::LogData {
            #[inline]
            fn from(this: &AccountProtocolFees) -> alloy_sol_types::private::LogData {
    ...
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    /**Event with signature `ClaimProtocolFees(address,uint256)` and selector `0x175b790d44599ca70432cc8d1406504cb3a28fc13ff995c06dde6663412b211a`.
```solidity
event ClaimProtocolFees(address indexed token, uint256 fees);
```*/
    #[allow(
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        #[automatically_derived]
        impl alloy_sol_types::SolEvent for ClaimProtocolFees {
            type DataTuple<'a> = (alloy::sol_types::sol_data::Uint<256>,);
            type DataToken<'a> = <Self::DataTuple<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            ...
            const SIGNATURE: &'static str = "ClaimProtocolFees(address,uint256)";
            const SIGNATURE_HASH: alloy_sol_types::private::B256 = alloy_sol_types::private::B256::new([
                23u8, 91u8, 121u8, 13u8, 68u8, 89u8, 156u8, 167u8, 4u8, 50u8, 204u8,
                141u8, 20u8, 6u8, 80u8, 76u8, 179u8, 162u8, 143u8, 193u8, 63u8, 249u8,
                149u8, 192u8, 109u8, 222u8, 102u8, 99u8, 65u8, 43u8, 33u8, 26u8,
            ]);
            const ANONYMOUS: bool = false;
            #[allow(unused_variables)]
            #[inline]
        ...
        #[automatically_derived]
        impl alloy_sol_types::private::IntoLogData for ClaimProtocolFees {
            fn to_log_data(&self) -> alloy_sol_types::private::LogData {
                From::from(self)
            }
            fn into_log_data(self) -> alloy_sol_types::private::LogData {
        ...
        #[automatically_derived]
        impl From<&ClaimProtocolFees> for alloy_sol_types::private::LogData {
            #[inline]
            fn from(this: &ClaimProtocolFees) -> alloy_sol_types::private::LogData {
                alloy_sol_types::SolEvent::encode_log_data(this)
            }
        }
    };
...
```*/
                ...
                },
                {
                    fn InvalidRecipient(
                        ...
                        <InvalidRecipient as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IProtocolFeesErrors::InvalidRecipient)
                    }
                    InvalidRecipient
                },
            ];
    ...
    pub enum IProtocolFeesEvents {
        #[allow(missing_docs)]
        AccountProtocolFees(AccountProtocolFees),
        #[allow(missing_docs)]
    ...
    impl IProtocolFeesEvents {
        ...
        /// The names of the variants in the same order as `SELECTORS`.
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(AccountProtocolFees),
            ::core::stringify!(ClaimProtocolFees),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <AccountProtocolFees as alloy_sol_types::SolEvent>::SIGNATURE,
            <ClaimProtocolFees as alloy_sol_types::SolEvent>::SIGNATURE,
        ];
        /// Returns the signature for the given selector, if known.
        #[inline]
        pub fn signature_by_selector(
    ...
    impl alloy_sol_types::SolEventInterface for IProtocolFeesEvents {
        ...
        fn decode_raw_log(
            ...
            match topics.first().copied() {
                Some(
                    <AccountProtocolFees as alloy_sol_types::SolEvent>::SIGNATURE_HASH,
                ) => {
                    <AccountProtocolFees as alloy_sol_types::SolEvent>::decode_raw_log(
                            topics,
                            data,
                        )
                        .map(Self::AccountProtocolFees)
                }
                Some(
                    <ClaimProtocolFees as alloy_sol_types::SolEvent>::SIGNATURE_HASH,
                ) => {
                    <ClaimProtocolFees as alloy_sol_types::SolEvent>::decode_raw_log(
                            topics,
                            data,
                        )
                        .map(Self::ClaimProtocolFees)
                }
                _ => {
    ...
    impl alloy_sol_types::private::IntoLogData for IProtocolFeesEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::AccountProtocolFees(inner) => {
...
See the [wrapper's documentation](`IProtocolFeesInstance`) for more details.*/
    ...
    > IProtocolFeesInstance<P, N> {
        ...
        ///Creates a new event filter for the [`AccountProtocolFees`] event.
        pub fn AccountProtocolFees_filter(
            &self,
        ) -> alloy_contract::Event<&P, AccountProtocolFees, N> {
            self.event_filter::<AccountProtocolFees>()
        }
        ///Creates a new event filter for the [`ClaimProtocolFees`] event.
        pub fn ClaimProtocolFees_filter(
            &self,
        ) -> alloy_contract::Event<&P, ClaimProtocolFees, N> {
            self.event_filter::<ClaimProtocolFees>()
        }
    }
}
