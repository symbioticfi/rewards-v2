...
export const iVaultSnapshotRewardsAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "maxRewards", internalType: "uint256", type: "uint256" },
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: "timestamp", internalType: "uint48", type: "uint48" },
          { name: "amount", internalType: "uint256", type: "uint256" },
          { name: "operatorsFee", internalType: "uint256", type: "uint256" },
        ],
      },
    ],
    stateMutability: "view",
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "amount", internalType: "uint256", type: "uint256", indexed: false },
      { name: "curatorFee", internalType: "uint256", type: "uint256", indexed: false },
      { name: "operatorsFee", internalType: "uint256", type: "uint256", indexed: false },
    ],
    name: "DistributeVaultSnapshotRewards",
  },
