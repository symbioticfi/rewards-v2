...
//
// Solidity: function distributeCumulativeMerkleRewards(address network, (uint48,bytes32) cumulativeDistribution, (uint64,address,uint256)[] totalAmounts, bytes protocolSignature, bytes rewarderSignature) returns()
func (_ICumulativeMerkleRewards *ICumulativeMerkleRewardsTransactor) DistributeCumulativeMerkleRewards(opts *bind.TransactOpts, network common.Address, cumulativeDistribution ICumulativeMerkleRewardsCumulativeDistribution, totalAmounts []ICumulativeMerkleRewardsTokenAmount, protocolSignature []byte, rewarderSignature []byte) (*types.Transaction, error) {
	return _ICumulativeMerkleRewards.contract.Transact(opts, "distributeCumulativeMerkleRewards", network, cumulativeDistribution, totalAmounts, protocolSignature, rewarderSignature)
}
...
func (_ICumulativeMerkleRewards *ICumulativeMerkleRewardsSession) DistributeCumulativeMerkleRewards(network common.Address, cumulativeDistribution ICumulativeMerkleRewardsCumulativeDistribution, totalAmounts []ICumulativeMerkleRewardsTokenAmount, protocolSignature []byte, rewarderSignature []byte) (*types.Transaction, error) {
	return _ICumulativeMerkleRewards.Contract.DistributeCumulativeMerkleRewards(&_ICumulativeMerkleRewards.TransactOpts, network, cumulativeDistribution, totalAmounts, protocolSignature, rewarderSignature)
}
