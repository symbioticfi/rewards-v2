...
//
// Solidity: function getCuratorFeeAt(address vault, address network, uint48 timestamp, bytes hint) view returns(uint256 fee)
func (_IFeeRegistry *IFeeRegistryCaller) GetCuratorFeeAt(opts *bind.CallOpts, vault common.Address, network common.Address, timestamp *big.Int, hint []byte) (*big.Int, error) {
	var out []interface{}
	err := _IFeeRegistry.contract.Call(opts, &out, "getCuratorFeeAt", vault, network, timestamp, hint)
...
//
// Solidity: function getCuratorFeeAt(address vault, address network, uint48 timestamp, bytes hint) view returns(uint256 fee)
func (_IFeeRegistry *IFeeRegistrySession) GetCuratorFeeAt(vault common.Address, network common.Address, timestamp *big.Int, hint []byte) (*big.Int, error) {
	return _IFeeRegistry.Contract.GetCuratorFeeAt(&_IFeeRegistry.CallOpts, vault, network, timestamp, hint)
}

// GetCuratorFeeAt is a free data retrieval call binding the contract method 0x55de9fec.
//
// Solidity: function getCuratorFeeAt(address vault, address network, uint48 timestamp, bytes hint) view returns(uint256 fee)
func (_IFeeRegistry *IFeeRegistryCallerSession) GetCuratorFeeAt(vault common.Address, network common.Address, timestamp *big.Int, hint []byte) (*big.Int, error) {
	return _IFeeRegistry.Contract.GetCuratorFeeAt(&_IFeeRegistry.CallOpts, vault, network, timestamp, hint)
}
...
//
// Solidity: function getOperatorsFeeAt(address vault, address network, uint48 timestamp, bytes hint) view returns(uint256 fee)
func (_IFeeRegistry *IFeeRegistryCaller) GetOperatorsFeeAt(opts *bind.CallOpts, vault common.Address, network common.Address, timestamp *big.Int, hint []byte) (*big.Int, error) {
	var out []interface{}
	err := _IFeeRegistry.contract.Call(opts, &out, "getOperatorsFeeAt", vault, network, timestamp, hint)
...
//
// Solidity: function getOperatorsFeeAt(address vault, address network, uint48 timestamp, bytes hint) view returns(uint256 fee)
func (_IFeeRegistry *IFeeRegistrySession) GetOperatorsFeeAt(vault common.Address, network common.Address, timestamp *big.Int, hint []byte) (*big.Int, error) {
	return _IFeeRegistry.Contract.GetOperatorsFeeAt(&_IFeeRegistry.CallOpts, vault, network, timestamp, hint)
}

// GetOperatorsFeeAt is a free data retrieval call binding the contract method 0xbc30c7b7.
//
// Solidity: function getOperatorsFeeAt(address vault, address network, uint48 timestamp, bytes hint) view returns(uint256 fee)
func (_IFeeRegistry *IFeeRegistryCallerSession) GetOperatorsFeeAt(vault common.Address, network common.Address, timestamp *big.Int, hint []byte) (*big.Int, error) {
	return _IFeeRegistry.Contract.GetOperatorsFeeAt(&_IFeeRegistry.CallOpts, vault, network, timestamp, hint)
}
