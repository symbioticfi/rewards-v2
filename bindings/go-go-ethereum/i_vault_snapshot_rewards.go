...
type IVaultSnapshotRewardsRewardDistribution struct {
	...
	Timestamp           *big.Int
	AmountToDeposits    *big.Int
	OperatorsFees       *big.Int
	AmountToWithdrawals *big.Int
}
...
//
// Solidity: function rewards(address vault, address network, address token, uint256 index) view returns((uint96,address,uint64,uint48,uint256,uint256,uint256))
...
//
// Solidity: function distributeVaultSnapshotRewards(bytes32 subnetwork, address token, address vault, uint256 amount, uint48 timestamp, bytes hints) returns()
func (_IVaultSnapshotRewards *IVaultSnapshotRewardsTransactor) DistributeVaultSnapshotRewards(opts *bind.TransactOpts, subnetwork [32]byte, token common.Address, vault common.Address, amount *big.Int, timestamp *big.Int, hints []byte) (*types.Transaction, error) {
	return _IVaultSnapshotRewards.contract.Transact(opts, "distributeVaultSnapshotRewards", subnetwork, token, vault, amount, timestamp, hints)
}

// DistributeVaultSnapshotRewards is a paid mutator transaction binding the contract method 0xc5a8f83c.
//
// Solidity: function distributeVaultSnapshotRewards(bytes32 subnetwork, address token, address vault, uint256 amount, uint48 timestamp, bytes hints) returns()
func (_IVaultSnapshotRewards *IVaultSnapshotRewardsSession) DistributeVaultSnapshotRewards(subnetwork [32]byte, token common.Address, vault common.Address, amount *big.Int, timestamp *big.Int, hints []byte) (*types.Transaction, error) {
	return _IVaultSnapshotRewards.Contract.DistributeVaultSnapshotRewards(&_IVaultSnapshotRewards.TransactOpts, subnetwork, token, vault, amount, timestamp, hints)
}

// DistributeVaultSnapshotRewards is a paid mutator transaction binding the contract method 0xc5a8f83c.
//
// Solidity: function distributeVaultSnapshotRewards(bytes32 subnetwork, address token, address vault, uint256 amount, uint48 timestamp, bytes hints) returns()
func (_IVaultSnapshotRewards *IVaultSnapshotRewardsTransactorSession) DistributeVaultSnapshotRewards(subnetwork [32]byte, token common.Address, vault common.Address, amount *big.Int, timestamp *big.Int, hints []byte) (*types.Transaction, error) {
	return _IVaultSnapshotRewards.Contract.DistributeVaultSnapshotRewards(&_IVaultSnapshotRewards.TransactOpts, subnetwork, token, vault, amount, timestamp, hints)
}
...
// FilterDistributeVaultSnapshotRewards is a free log retrieval operation binding the contract event 0x05c1d8b3935bb51c011b28af51abb779b5546f769ed420493bee18034fc35747.
//
// Solidity: event DistributeVaultSnapshotRewards(address indexed network, address indexed token, address indexed vault, uint96 subnetworkId, uint48 timestamp, uint256 amount, uint256 operatorsFees)
...
// WatchDistributeVaultSnapshotRewards is a free log subscription operation binding the contract event 0x05c1d8b3935bb51c011b28af51abb779b5546f769ed420493bee18034fc35747.
//
// Solidity: event DistributeVaultSnapshotRewards(address indexed network, address indexed token, address indexed vault, uint96 subnetworkId, uint48 timestamp, uint256 amount, uint256 operatorsFees)
...
// ParseDistributeVaultSnapshotRewards is a log parse operation binding the contract event 0x05c1d8b3935bb51c011b28af51abb779b5546f769ed420493bee18034fc35747.
//
// Solidity: event DistributeVaultSnapshotRewards(address indexed network, address indexed token, address indexed vault, uint96 subnetworkId, uint48 timestamp, uint256 amount, uint256 operatorsFees)
