...
// DistributeVaultSnapshotRewards is a paid mutator transaction binding the contract method 0x8520ae9d.
//
// Solidity: function distributeVaultSnapshotRewards(bytes32 subnetwork, address token, address vault, uint256 amount, uint48 timestamp, (bytes,bytes,bytes) hints) returns()
