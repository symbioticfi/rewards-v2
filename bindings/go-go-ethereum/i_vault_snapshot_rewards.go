...
type IVaultSnapshotRewardsClaimOperatorFee struct {
	...
	Vault              common.Address
	Amount             *big.Int
	LastUnclaimedIndex *big.Int
	Raw                types.Log // Blockchain specific contextual infos
}

// FilterClaimOperatorFee is a free log retrieval operation binding the contract event 0x641df03b69eecb40f0fd6d2222dcd4be8d6647e22f7d67b616a4c5060a40a4b0.
//
// Solidity: event ClaimOperatorFee(address indexed operator, address indexed network, address indexed token, address vault, uint256 amount, uint256 lastUnclaimedIndex)
...
// WatchClaimOperatorFee is a free log subscription operation binding the contract event 0x641df03b69eecb40f0fd6d2222dcd4be8d6647e22f7d67b616a4c5060a40a4b0.
//
// Solidity: event ClaimOperatorFee(address indexed operator, address indexed network, address indexed token, address vault, uint256 amount, uint256 lastUnclaimedIndex)
...
// ParseClaimOperatorFee is a log parse operation binding the contract event 0x641df03b69eecb40f0fd6d2222dcd4be8d6647e22f7d67b616a4c5060a40a4b0.
//
// Solidity: event ClaimOperatorFee(address indexed operator, address indexed network, address indexed token, address vault, uint256 amount, uint256 lastUnclaimedIndex)
...
// FilterClaimVaultSnapshotRewards is a free log retrieval operation binding the contract event 0xd8f94d65ed91a472c43c686de655441a338adc510a14a16461c27d27105cdaf1.
//
// Solidity: event ClaimVaultSnapshotRewards(address indexed staker, address indexed network, address indexed token, address vault, uint256 amount, uint256 lastUnclaimedIndex)
...
// WatchClaimVaultSnapshotRewards is a free log subscription operation binding the contract event 0xd8f94d65ed91a472c43c686de655441a338adc510a14a16461c27d27105cdaf1.
//
// Solidity: event ClaimVaultSnapshotRewards(address indexed staker, address indexed network, address indexed token, address vault, uint256 amount, uint256 lastUnclaimedIndex)
...
// ParseClaimVaultSnapshotRewards is a log parse operation binding the contract event 0xd8f94d65ed91a472c43c686de655441a338adc510a14a16461c27d27105cdaf1.
//
// Solidity: event ClaimVaultSnapshotRewards(address indexed staker, address indexed network, address indexed token, address vault, uint256 amount, uint256 lastUnclaimedIndex)
