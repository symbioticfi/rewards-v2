...
//
// Solidity: event ClaimOperatorFee(address indexed operator, address indexed network, address indexed token, address vault, uint256 amount, uint256 firstClaimedRewardIndex, uint256 rewardsClaimed)
...
//
// Solidity: event ClaimVaultSnapshotRewards(address indexed staker, address indexed network, address indexed token, address vault, uint256 amount, uint256 firstClaimedRewardIndex, uint256 rewardsClaimed)
