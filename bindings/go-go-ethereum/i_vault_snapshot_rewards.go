...
// IVaultSnapshotRewardsDistributeVaultSnapshotRewardsHints is an auto generated low-level Go binding around an user-defined struct.
type IVaultSnapshotRewardsDistributeVaultSnapshotRewardsHints struct {
	ActiveSharesHint               []byte
	CuratorFeeHint                 []byte
	OperatorsFeeHint               []byte
	TotalOperatorNetworkSharesHint []byte
}
...
// DistributeVaultSnapshotRewards is a paid mutator transaction binding the contract method 0xf9685f8a.
//
// Solidity: function distributeVaultSnapshotRewards(bytes32 subnetwork, address token, address vault, uint256 amount, uint48 timestamp, (bytes,bytes,bytes,bytes) hints) returns()
func (_IVaultSnapshotRewards *IVaultSnapshotRewardsTransactor) DistributeVaultSnapshotRewards(opts *bind.TransactOpts, subnetwork [32]byte, token common.Address, vault common.Address, amount *big.Int, timestamp *big.Int, hints IVaultSnapshotRewardsDistributeVaultSnapshotRewardsHints) (*types.Transaction, error) {
...
//
// Solidity: function distributeVaultSnapshotRewards(bytes32 subnetwork, address token, address vault, uint256 amount, uint48 timestamp, (bytes,bytes,bytes,bytes) hints) returns()
func (_IVaultSnapshotRewards *IVaultSnapshotRewardsSession) DistributeVaultSnapshotRewards(subnetwork [32]byte, token common.Address, vault common.Address, amount *big.Int, timestamp *big.Int, hints IVaultSnapshotRewardsDistributeVaultSnapshotRewardsHints) (*types.Transaction, error) {
...
//
// Solidity: function distributeVaultSnapshotRewards(bytes32 subnetwork, address token, address vault, uint256 amount, uint48 timestamp, (bytes,bytes,bytes,bytes) hints) returns()
func (_IVaultSnapshotRewards *IVaultSnapshotRewardsTransactorSession) DistributeVaultSnapshotRewards(subnetwork [32]byte, token common.Address, vault common.Address, amount *big.Int, timestamp *big.Int, hints IVaultSnapshotRewardsDistributeVaultSnapshotRewardsHints) (*types.Transaction, error) {
	return _IVaultSnapshotRewards.Contract.DistributeVaultSnapshotRewards(&_IVaultSnapshotRewards.TransactOpts, subnetwork, token, vault, amount, timestamp, hints)
}
