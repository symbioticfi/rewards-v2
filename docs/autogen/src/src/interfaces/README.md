...
# Contents
- [base](/src/interfaces/base)
- [ICumulativeMerkleRewards](ICumulativeMerkleRewards.sol/interface.ICumulativeMerkleRewards.md)
- [ICuratorRegistry](ICuratorRegistry.sol/interface.ICuratorRegistry.md)
